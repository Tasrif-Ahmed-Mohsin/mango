...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${poppins.className} ${fraunces.variable} ${bebas.variable} antialiased bg-[#FBF7F0] text-[#0A4027] tracking-tight`}
        style={{ backgroundColor: '#FBF7F0', color: '#0A4027' }}
      >
        <DataProvider>
          <CartProvider>
            {/* Main Header */}
